          ...
          <div className="grid gap-4">
            <Card>
              <CardHeader className="grid gap-1">
                <CardTitle className="text-base font-semibold">Vehicle Number</CardTitle>
                <CardDescription className="text-sm text-gray-500 dark:text-gray-400">KL 05 AQ 4567</CardDescription>
              </CardHeader>
            </Card>
            <Card>
              <CardHeader>
                ...
                <div className="grid gap-4 md:gap-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="grid gap-1">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">Aluva, Kerala</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <MapPinIcon className="h-6 w-6 text-gray-500 dark:text-gray-400" />
                    <div className="grid gap-1">
                      <h2 className="font-semibold">PULINCHODE SIGNAL JUNCTION</h2>
                      <p className="text-sm text-gray-500 dark:text-gray-400">Pulinchode, Kerala</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <MapPinIcon className="h-6 w-6 text-gray-500 dark:text-gray-400" />
                    <div className="grid gap-1">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">Companypadi, Kerala</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
                    <MapPinIcon className="h-6 w-6 text-gray-500 dark:text-gray-400" />
                    <div className="grid gap-1">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">Muttom, Kerala</p>
                    </div>
                  </div>
                </div>
              </CardContent>
